...
def estandarizar_dataset(directorio_base, tamano=(96, 96)):
    ...
    for clase in clases:
        ...
        for img_path in imagenes:
            try:
                ...
                # Redimensionar agilizar
                img_resized = cv2.resize(img, tamano)
                
                # Sobrescribir la imagen con el tamano corredto
    ...
    print(f"Procesamiento listo. Imágenes válidas: {imagenes_procesadas}. Eliminadas: {imagenes_corruptas}")
